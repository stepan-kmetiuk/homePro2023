...
!function(C){var t={init:function(_){var f=C.extend({placeholder:!1,allowClear:!1,autofocus:!0,countryFlag:!!C(this).attr("data-wpm-countryflag")&&"true"==C(this).attr("data-wpm-countryflag"),search:!!C(this).attr("data-wpm-search")&&"true"==C(this).attr("data-wpm-search")},_),u=f.search?"wpm-select-wrap_open":"wpm-select-wrap_open-dropdown";return this.each(function(){var t,o,i,a,n,l=this,p=(C(l).css({position:"absolute",zIndex:"-1",opacity:"0",display:"none",pointerEvents:"none",width:"1px",height:"1px"}),C(l).on("change",function(){var o=C(this).val();console.log("change"),c.trigger("click",!0),h.children().filter(function(e,t){o.toLowerCase().trim()===C(this).attr("data-wpmval").toLowerCase().trim()&&m(C(t),!0)})}),0===C(this).find("option[selected]").length&&(f.placeholder||C(this).attr("data-wpm-placeholder")&&"false"!==C(this).attr("data-wpm-placeholder"))&&"false"!==C(this).attr("data-wpm-placeholder")&&(t=C(this).attr("data-wpm-placeholder")?C(this).attr("data-wpm-placeholder"):f.placeholder,C(l).prepend('<option disabled value=""></option>'),C(l).val(C(l).children().first().val())),{options:[]}),d=C('<div tabindex="0" class="wpm-select-wrap"></div>'),c=C('<div class="wpm-select-placeholder"></div>'),e=(t?(a=C("<div class='wpm-select-placeholder__single'></div>"),c.append(a),o=C("<div class='wpm-select-placeholder__rendered'>"+t+"</div>"),c.append(o)):(a=f.countryFlag?(i="flag-icon flag-icon-squared flag-icon-",0!==C(this).find("option[selected]").length?(i+=C(l).find("option[selected]").attr("data-wpm-id").toLowerCase(),C("<div class='wpm-select-placeholder__single'><span class=\""+i+'"></span>'+C(l).find("option[selected]").text()+"</div>")):(i+=C(l.options[0]).attr("data-wpm-id").toLowerCase(),C("<div class='wpm-select-placeholder__single'><span class=\""+i+'"></span>'+l.options[0].innerText+"</div>"))):0!==C(this).find("option[selected]").length?C("<div class='wpm-select-placeholder__single'>"+C(l).find("option[selected]").text()+"</div>"):C("<div class='wpm-select-placeholder__single'>"+l.options[0].innerText+"</div>"),c.append(a)),C('<div class="wpm-select-placeholder__buttons"></div>')),s=C('<div class="wpm-select-placeholder__arrow"><svg width="12" height="6" viewBox="0 0 12 6" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M6 6L12 0L0 -5.24537e-07L6 6Z" fill="#7A7A7A"/> </svg></div>'),r=(c.append(e),s.on("click",function(e){d.hasClass(u)&&(e.preventDefault(),e.stopPropagation(),v=!1,d.removeClass(u))}),e.append(s),f.allowClear&&f.search&&(s=C('<div style="opacity: 0;" class="wpm-select-placeholder__clear"><svg height="20" width="20" viewBox="0 0 20 20"><path fill="rgb(40, 43, 93)" d="M14.348 14.849c-0.469 0.469-1.229 0.469-1.697 0l-2.651-3.030-2.651 3.029c-0.469 0.469-1.229 0.469-1.697 0-0.469-0.469-0.469-1.229 0-1.697l2.758-3.15-2.759-3.152c-0.469-0.469-0.469-1.228 0-1.697s1.228-0.469 1.697 0l2.652 3.031 2.651-3.031c0.469-0.469 1.228-0.469 1.697 0s0.469 1.229 0 1.697l-2.758 3.152 2.758 3.15c0.469 0.469 0.469 1.229 0 1.698z"></path></svg></div>'),e.prepend(s),s.on("click",function(e){d.hasClass(u)||(h.html(""),t?(C(l).val(""),a.text(""),o.text(t)):(C(l).val(C(l.options).first().val()),f.countryFlag?a.html('<span class="'+i+'"></span>'+l.options[0].innerText):a.text(C(l.options).first().text())),a.removeClass("wpm-select-placeholder__single_active"),h.find(".wpm-select-dropdown__option").first().addClass("wpm-select-dropdown__option_highlighted").siblings().removeClass("wpm-select-dropdown__option_highlighted"),n.focus(),n.val("").trigger("keyup"),v=!0,d.addClass(u),void 0!==_.onClear&&_.onClear(C(l)))})),f.search&&(n=C('<input tabindex="20" type="text" class="wpm-select-placeholder__search">'),c.prepend(n),n.on("keyup",function(e){clearTimeout(void 0);var t=C(this),o=(h.html(""),t.val().toLowerCase().trim());o?p.options.filter(function(e){-1<C(e).text().toLowerCase().trim().indexOf(o)&&h.append(C(e))}):p.options.filter(function(e){h.append(C(e))}),h&&h.find(".wpm-select-dropdown__option").first().addClass("wpm-select-dropdown__option_highlighted"),w(h.find(".wpm-select-dropdown__option")),0==h.children().length&&h.html('<div class="wpm-select-dropdown__empty">No options</div>'),"Enter"!==e.key&&13!==e.keyCode||m(h.find(".wpm-select-dropdown__option_highlighted"),!0)}),n.on("keydown",function(e){9===e.keyCode&&m(h.find(".wpm-select-dropdown__option_highlighted"),!0)})),d.append(c),C(this).find("option:not([disabled])").length?d.hasClass("wpm-select-wrap_disabled")&&d.removeClass("wpm-select-wrap_disabled"):d.addClass("wpm-select-wrap_disabled"),C(l).after(d),C('<div class="wpm-select-dropdown-container"></div>')),h=C('<div class="wpm-select-dropdown"></div>');function w(e){e.on("mouseenter",function(){C(this).addClass("wpm-select-dropdown__option_highlighted").siblings().removeClass("wpm-select-dropdown__option_highlighted")}),m(e)}function m(e,t){e.on("click",function(e){e.stopPropagation(),e.stopImmediatePropagation();var i=C(this).attr("data-wpmval").toLowerCase().trim(),e=C(this).html();c.find(".wpm-select-placeholder__single").html(e).addClass("wpm-select-placeholder__single_active"),v=!1,d.removeClass(u),C(l.options).filter(function(e,t){var o=C(t).val().toLowerCase().trim();i===o&&C(l).val(C(t).val())}),void 0!==_.onSelected&&_.onSelected(C(l))}),t&&e.trigger("click")}r.append(h),C("body").on("click",function(e){v=!1,d.removeClass(u)});var v=!1,g=!1;c.on("click",function(e,t){if(e.stopPropagation(),!g){g=!0;for(var o,i,a=document.createDocumentFragment(),s=0;s<l.options.length;s++)l.options[s].value&&((e=document.createElement("div")).className="wpm-select-dropdown__option",e.setAttribute("data-wpmval",C(l.options[s]).clone().val()),e.textContent=C(l.options[s]).clone().text(),f.countryFlag&&(o="flag-icon flag-icon-squared flag-icon-"+C(l.options[s]).attr("data-wpm-id").toLowerCase(),(i=document.createElement("span")).className=o,e.prepend(i)),a.appendChild(e),f.countryFlag?p.options.push('<div class="wpm-select-dropdown__option" data-wpmval="'+C(l.options[s]).val()+'"><span class="'+o+'"></span>'+C(l.options[s]).text()+"</div>"):p.options.push('<div class="wpm-select-dropdown__option" data-wpmval="'+C(l.options[s]).val()+'">'+C(l.options[s]).text()+"</div>"));h.get(0).appendChild(a),c.after(r)}v||(t||(v=!0),h.find(".wpm-select-dropdown__option_highlighted").length||h.find(".wpm-select-dropdown__option").first().addClass("wpm-select-dropdown__option_highlighted"),t||(d.addClass(u),f.autofocus&&f.search&&n.get(0).focus()),w(h.find(".wpm-select-dropdown__option")))}),f.search||d.on("blur",function(e){v=!1,d.removeClass(u)}),void 0!==_.onInit&&_.onInit(C(l))})},show:function(){},hide:function(){},setVal:function(e){var t=this;e&&C(this).children().each(function(){(C(this).val()&&C(this).val().toLowerCase().trim())===(e&&e.toLowerCase().trim())&&(console.log("est"),C(t).val(e).trigger("change"))})},reInit:function(e){e=e||{};this.next().remove(),this.wpmSelect(e)}};C.fn.wpmSelect=function(e){return t[e]?t[e].apply(this,Array.prototype.slice.call(arguments,1)):"object"!=typeof e&&e?void C.error("Method "+e+" does not exist on jQuery.wpmSelect"):t.init.apply(this,arguments)}}(jQuery);